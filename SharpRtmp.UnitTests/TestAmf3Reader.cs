...
public class TestCls : IDynamicObject, IEquatable<TestCls>
{
    ...
    public void AddDynamic(string key, object data) => _dynamicFields.Add(key, data);

    public bool Equals(TestCls other) 
        => T1 == other.T1 && T2 == other.T2 && T3 == other.T3 && (t4?.Equals(other.t4) ?? t4 == other.t4) && _dynamicFields.SequenceEqual(other._dynamicFields);
...
public class TestAmf3Reader
{
    ...
    public void TestReadPacket1()
    {
        ...
        file.Read(data);
        Assert.IsTrue(reader.TryGetPacket(data, out var headers, out _, out var consumed));
    ...
    public void TestUndefined()
    {
        ...
        var data = new byte[file.Length];
        file.Read(data);
        Assert.IsTrue(reader.TryGetUndefined(data, out _, out var consumed));
    ...
    public void TestNull()
    {
        ...
        var data = new byte[file.Length];
        file.Read(data);
        Assert.IsTrue(reader.TryGetNull(data, out _, out var consumed));
