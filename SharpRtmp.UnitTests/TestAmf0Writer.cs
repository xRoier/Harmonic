...
public class TestAmf0Writer
{
    ...
    public void TestArray()
    {
        ...
        Assert.IsTrue(reader.TryGetStrictArray(buffer, out var val, out _));
    ...
    public void TestEcmaArray()
    {
        ...
        Assert.IsTrue(reader.TryGetEcmaArray(buffer, out var readData, out _));
    ...
    public void TestObject()
    {
        ...
        Assert.IsTrue(reader.TryGetObject(buffer, out _, out var consumed));
        Assert.AreEqual(consumed, buffer.Length);
    }
